    ...
    return (
        <main className="min-h-screen bg-[#F7F9FF]">
            ...
            <div className="max-w-6xl mx-auto px-6 py-8 grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-12 items-start">
                {/* Main Content */}
                <div>
                    <h1 className="text-3xl font-bold text-[#0A0A0A] mb-2">Carpet Area / Built-up Area / Super Built-up Area Calculator</h1>
                    <p className="text-[#6b7280] mb-6">Understand and calculate different types of property areas</p>
                        ...
                        <div className="bg-white rounded-xl p-6 border border-[#e5e7eb]">
                            ...
                            <div className="bg-[#f8f9fa] p-6 rounded-xl mb-4">
                                <div className="text-center mb-4 text-sm text-gray-600">
                                    <i className="fas fa-hand-pointer text-[#3B68FC] mr-2"></i>
                                    On this image, following areas are considered in <span className="font-bold text-[#3B68FC]">Carpet area</span>
                                </div>
                                <div className="flex justify-center">
                                    <div className="border-4 border-gray-300 p-8 relative bg-white" style={{ width: '280px' }}>
                                        ...
                                        <div className="absolute -bottom-6 left-1/2 -translate-x-1/2 bg-[#3B68FC] text-white px-4 py-1 rounded text-sm font-bold">
                                            CARPET AREA
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="mt-4 bg-[#f8f9fa] p-4 rounded-lg">
                                ...
                                <code className="text-sm text-[#3B68FC]">
                    ...
                    <section className="mb-8">
                        <h2 className="text-xl font-bold text-[#0A0A0A] mb-4 flex items-center gap-2">
                            <i className="fas fa-building text-[#3B68FC]"></i>
                            What is Built-up area?
                        </h2>
                        <div className="bg-white rounded-xl p-6 border border-[#e5e7eb]">
                            <p className="text-[#0A0A0A] leading-relaxed mb-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                                ...
                                <div className="bg-blue-50 border border-blue-200 p-4 rounded-lg">
                                    <div className="font-bold text-blue-800 mb-2">How to calculate Built-up area?</div>
                    ...
                    <section className="mb-8">
                        <h2 className="text-xl font-bold text-[#0A0A0A] mb-4 flex items-center gap-2">
                            <i className="fas fa-city text-[#3B68FC]"></i>
                            What is Super Built-up area?
                        </h2>
                        <div className="bg-white rounded-xl p-6 border border-[#e5e7eb]">
                            <p className="text-[#0A0A0A] leading-relaxed mb-4">
                            ...
                            <div className="bg-[#f8f9fa] p-6 rounded-xl mb-4">
                                <div className="flex justify-center">
                                    <div className="border-8 border-blue-400 p-4 relative bg-blue-50" style={{ width: '320px' }}>
                                        ...
                                        <div className="border-4 border-gray-400 p-4 bg-white">
                                            <div className="grid grid-cols-3 gap-1 text-xs text-center">
                                                <div className="bg-blue-100 p-2 rounded">Bed</div>
                                                <div className="bg-green-100 p-2 rounded">Kit</div>
                                                <div className="bg-purple-100 p-2 rounded">WC</div>
                                            </div>
                                        </div>
                                        <div className="absolute -bottom-6 left-1/2 -translate-x-1/2 bg-blue-600 text-white px-4 py-1 rounded text-sm font-bold">
                                            SUPER BUILT UP AREA
                                        </div>
                                    </div>
                                </div>
                ...
                <aside ref={sidebarRef} className="sticky top-20 h-fit">
                    <div className="bg-white rounded-2xl shadow-[0_4px_20px_rgba(0,0,0,0.08)] overflow-hidden border border-[#e5e7eb]">
                        <div className="px-5 py-4 border-b border-[#e5e7eb] flex items-center gap-3 bg-gradient-to-r from-purple-50 to-pink-50">
                            <i className="fas fa-vector-square text-xl text-purple-500"></i>
                            <h2 className="font-semibold text-[#0A0A0A]">CARPET AREA CALCULATOR</h2>
                        </div>
                        ...
                        <div className="p-5">
                            ...
                            <div className="mb-4">
                                ...
                                <div className="flex border border-[#e5e7eb] rounded-lg overflow-hidden">
                                    <button onClick={() => setUnit('Feet')} className={`flex-1 py-2 text-sm font-medium transition-colors ${unit === 'Feet' ? 'bg-[#3B68FC] text-white' : 'text-[#6b7280] hover:bg-[#f8f9fa]'}`}>Sq. Feet</button>
                                    <button onClick={() => setUnit('Meter')} className={`flex-1 py-2 text-sm font-medium transition-colors ${unit === 'Meter' ? 'bg-[#3B68FC] text-white' : 'text-[#6b7280] hover:bg-[#f8f9fa]'}`}>Sq. Meter</button>
                                </div>
                            </div>
                            ...
                            <div className="mb-4">
                                ...
                                <input type="number" value={loading} onChange={(e) => setLoading(Number(e.target.value))} className="w-full px-3 py-2 border border-[#e5e7eb] rounded-lg text-sm" />
                            </div>
                            ...
                            <div className="space-y-3">
                                <div className="bg-green-50 border border-green-200 rounded-xl p-4 text-center">
                                    <div className="text-xs text-green-700 mb-1">Carpet Area (70% of Built-up)</div>
                                    <div className="text-2xl font-bold text-green-600">{results?.carpetArea} sq.ft</div>
                                    <div className="text-xs text-green-600">{results?.carpetM} sq.m</div>
                                </div>
