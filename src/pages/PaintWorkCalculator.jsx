                    ...
                    <section className="mb-8">
                        <div className="bg-white rounded-xl p-6 border border-[#e5e7eb]">
                            ...
                            <table className="w-full text-sm border-collapse">
                                ...
                                <tbody>
                                    <tr><td className="border px-3 py-2">1</td><td className="border px-3 py-2">Paint</td><td className="border px-3 py-2 font-bold">{results?.paint} liters</td></tr>
                                    <tr><td className="border px-3 py-2">2</td><td className="border px-3 py-2">Primer</td><td className="border px-3 py-2 font-bold">{results?.primer} liters</td></tr>
                                    <tr><td className="border px-3 py-2">3</td><td className="border px-3 py-2">Putty</td><td className="border px-3 py-2 font-bold">{results?.putty} kgs</td></tr>
                                </tbody>
                            </table>
                        </div>
                    </section>
                    ...
                    <section className="mb-8">
                        ...
                        <div className="bg-white rounded-xl p-6 border border-[#e5e7eb]">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div className="bg-white border rounded-xl p-4 text-center"><div className="w-12 h-12 bg-red-100 rounded-full mx-auto mb-2 flex items-center justify-center"><i className="fas fa-paint-roller text-red-500"></i></div><div className="font-bold">Paint</div><div className="text-xl font-bold text-red-500">{results?.paint} liter</div></div>
                                <div className="bg-white border rounded-xl p-4 text-center"><div className="w-12 h-12 bg-blue-100 rounded-full mx-auto mb-2 flex items-center justify-center"><i className="fas fa-fill-drip text-blue-500"></i></div><div className="font-bold">Primer</div><div className="text-xl font-bold text-blue-500">{results?.primer} liter</div></div>
                                <div className="bg-white border rounded-xl p-4 text-center"><div className="w-12 h-12 bg-amber-100 rounded-full mx-auto mb-2 flex items-center justify-center"><i className="fas fa-layer-group text-amber-500"></i></div><div className="font-bold">Putty</div><div className="text-xl font-bold text-amber-500">{results?.putty} kgs</div></div>
                            </div>
                        </div>
                    </section>
