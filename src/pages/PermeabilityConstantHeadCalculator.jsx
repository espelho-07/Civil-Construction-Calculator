                ...
                <div>
                    ...
                    <section className="mb-8">
                        ...
                        <div className={`bg-white rounded-xl p-6 border ${theme.border}`}>
                            <p className="text-gray-600 mb-4 text-justify">The Constant-Head Permeability Test is used to find the permeability or hydraulic conductivity of relatively coarse-grained soils (sands and gravels). A constant head of water is maintained across the soil sample and the quantity of water flowing through the sample is measured over a period of time.</p>
                            <p className="text-gray-600 text-justify">The test is performed by maintaining a constant head and measuring the quantity of water that passes through an undisturbed soil sample in a given length of time.</p>
                        </div>
                    </section>
