                ...
                <div>
                    <div className="flex items-center justify-between mb-4">
                        <div>
                            ...
                            <p className="text-[#6b7280]">Calculate number of concrete blocks, cement and sand for masonry work</p>
                        </div>
                        <CalculatorActions
                            ...
                            inputs={{ unit, length, lengthInch, height, heightInch, wallThickness, blockL, blockW, blockH, ratio }}
                            outputs={results || {}}
                        />
                    </div>
