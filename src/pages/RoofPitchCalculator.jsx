...
export default function RoofPitchCalculator() {
    ...
    const reset = () => {
        setUnit('Meter');
        setRise(10); setRiseCm(0);
        setRun(15); setRunCm(0);
        setResults(null);
    };
        ...
        <main className="min-h-screen bg-[#F7F9FF]">
            ...
            <div className="max-w-6xl mx-auto px-6 py-8 grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-12 items-start">
                <div>
                        ...
                        <div className={`bg-white rounded-xl p-6 border ${theme.border}`}>
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div className={`${theme.bgLight} p-4 rounded-lg text-center`}>
                                    ...
                                    <div className={`text-2xl font-bold ${theme.text}`}>= {results?.pitch}</div>
                                </div>
                                <div className={`${theme.bgLight} p-4 rounded-lg text-center`}>
                                    ...
                                    <div className={`text-2xl font-bold ${theme.text}`}>= {results?.slope} %</div>
                                </div>
                                <div className={`${theme.bgLight} p-4 rounded-lg text-center`}>
                                    ...
                                    <div className="text-2xl font-bold text-amber-500">= {results?.angle} Degree</div>
                                </div>
                            </div>
                        </div>
                    </section>
                    ...
                    <section className="mb-8">
                        <div className="bg-green-50 border border-green-200 rounded-xl p-4 text-sm text-green-700 text-justify">
                    ...
                    <section className="mb-8">
                        ...
                        <div className={`bg-white rounded-xl p-6 border ${theme.border} flex flex-col md:flex-row gap-6`}>
                            <div className="flex-1">
                                <div className={`${theme.bgLight} p-4 rounded-lg font-mono ${theme.text} space-y-2`}>
                    ...
                    <section className="mb-8">
                        ...
                        <div className={`bg-white rounded-xl p-6 border ${theme.border} space-y-4`}>
                            <div className="flex items-start gap-3">
                                ...
                                <div><strong className="text-gray-800">Low Roof Pitch/Slope –</strong> <span className="text-gray-600 text-justify">This type of roof would have at least a 3:12 pitch, which means that a roof rises 3 feet for every 12 feet of its base horizontal length (not greater than 5:12). Roofing. This type of roof is considered to be "walk-able", and easy for performing a roof installation.</span></div>
                            </div>
                            <div className="flex items-start gap-3">
                                ...
                                <div><strong className="text-gray-800">Medium Roof Pitch/Slope –</strong> <span className="text-gray-600 text-justify">The roof of this type would fall within 6:12 – 9:12 roofing slope range Roofing. These roofs with intermediate pitch / average slope roofs are considered to be "non walk-able", as they represent a higher degree of complexity, therefore they are more expensive to install.</span></div>
                            </div>
                            <div className="flex items-start gap-3">
                                ...
                                <div><strong className="text-gray-800">High/Steep Roof Pitch/Slope –</strong> <span className="text-gray-600 text-justify">Roofs in this category have a slope that is greater than 9 inches of rise for every foot of horizontal roof's run. Roofing. The high sloped roof is, perhaps, the most difficult and dangerous roofing surface to work on. You may expect to pay a higher price for this type of roof per square of installation.</span></div>
                            </div>
                        </div>
                    </section>
                ...
                <aside ref={sidebarRef} className="sticky top-20 h-fit">
                    <div className="bg-white rounded-2xl shadow-lg border border-[#e5e7eb]">
                        ...
                        <div className="p-5">
                            ...
                            <div className={`${theme.bgLight} rounded-xl p-4 text-center space-y-2`}>
                                <div><div className="text-xs text-gray-500">Roof Pitch</div><div className={`text-xl font-bold ${theme.text}`}>{results?.pitch}</div></div>
