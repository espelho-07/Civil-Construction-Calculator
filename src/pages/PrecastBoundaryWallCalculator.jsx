                ...
                <div>
                    <div className="flex items-center justify-between mb-4">
                        <div>
                            ...
                            <p className="text-[#6b7280]">Calculate horizontal bars and vertical posts for precast compound wall</p>
                        </div>
                        <CalculatorActions
                            calculatorSlug="precast-boundary-wall-calculator"
                            calculatorName="Precast Boundary Wall Calculator"
                            calculatorIcon="fa-border-style"
                            category="Quantity Estimator"
                            inputs={{ unit, areaLength, areaHeight, barLength, barHeight }}
                            outputs={results || {}}
                        />
                    </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                ...
                                <div className="bg-[#f8f9fa] p-5 rounded-xl">
                                    ...
                                    <div className="space-y-3 text-sm">
                                        <div className={`bg-white p-3 rounded ${theme.border}`}>
                                    ...
                                    <div className="mt-6">
                                        ...
                                        <div className={`bg-white p-3 rounded ${theme.border} font-mono text-xs`}>
                                        ...
                                        <div className={`bg-white p-3 rounded ${theme.border} font-mono text-xs mt-2`}>
                    ...
                    <section className="mb-8">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                            {relatedCalculators.map((calc) => (
                                <Link key={calc.name} to={calc.slug} className={`bg-white ${theme.border} rounded-lg p-4 hover:shadow-lg ${theme.hover.replace('bg-', 'border-')} transition-all group`}>
                    ...
                    <div className={`bg-white rounded-2xl shadow-[0_4px_20px_rgba(0,0,0,0.08)] ${theme.border}`}>
                        ...
                        <div className="p-5">
                            ...
                            <div className="mb-3">
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                    <div className="relative">
                                        <input type="number" value={areaLength} onChange={(e) => setAreaLength(Number(e.target.value))} className={`w-full px-3 py-2 pr-10 ${theme.border} rounded-lg text-sm ${theme.focus} outline-none`} />
                                        <span className="absolute right-3 top-1/2 -translate-y-1/2 text-xs text-gray-400">feet</span>
                                    </div>
                                    <div className="relative">
                                        <input type="number" value={areaLengthInch} onChange={(e) => setAreaLengthInch(Number(e.target.value))} className={`w-full px-3 py-2 pr-10 ${theme.border} rounded-lg text-sm ${theme.focus} outline-none`} />
                            ...
                            <div className="mb-3">
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                    <div className="relative">
                                        <input type="number" value={areaHeight} onChange={(e) => setAreaHeight(Number(e.target.value))} className={`w-full px-3 py-2 pr-10 ${theme.border} rounded-lg text-sm ${theme.focus} outline-none`} />
                                        <span className="absolute right-3 top-1/2 -translate-y-1/2 text-xs text-gray-400">feet</span>
                                    </div>
                                    <div className="relative">
                                        <input type="number" value={areaHeightInch} onChange={(e) => setAreaHeightInch(Number(e.target.value))} className={`w-full px-3 py-2 pr-10 ${theme.border} rounded-lg text-sm ${theme.focus} outline-none`} />
                                        <span className="absolute right-3 top-1/2 -translate-y-1/2 text-xs text-gray-400">inch</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="mb-3">
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                    <div className="relative">
                                        <input type="number" value={barLength} onChange={(e) => setBarLength(Number(e.target.value))} className={`w-full px-3 py-2 pr-10 ${theme.border} rounded-lg text-sm ${theme.focus} outline-none`} />
                                        <span className="absolute right-3 top-1/2 -translate-y-1/2 text-xs text-gray-400">feet</span>
                                    </div>
                                    <div className="relative">
                                        <input type="number" value={barLengthInch} onChange={(e) => setBarLengthInch(Number(e.target.value))} className={`w-full px-3 py-2 pr-10 ${theme.border} rounded-lg text-sm ${theme.focus} outline-none`} />
                                        <span className="absolute right-3 top-1/2 -translate-y-1/2 text-xs text-gray-400">inch</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="mb-4">
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                    <div className="relative">
                                        <input type="number" value={barHeight} onChange={(e) => setBarHeight(Number(e.target.value))} className={`w-full px-3 py-2 pr-10 ${theme.border} rounded-lg text-sm ${theme.focus} outline-none`} />
                                        <span className="absolute right-3 top-1/2 -translate-y-1/2 text-xs text-gray-400">feet</span>
                                    </div>
                                    <div className="relative">
                                        <input type="number" value={barHeightInch} onChange={(e) => setBarHeightInch(Number(e.target.value))} className={`w-full px-3 py-2 pr-10 ${theme.border} rounded-lg text-sm ${theme.focus} outline-none`} />
                                        <span className="absolute right-3 top-1/2 -translate-y-1/2 text-xs text-gray-400">inch</span>
                                    </div>
                                </div>
                            </div>
                                ...
                                <table className="w-full text-xs border-collapse">
                                    <thead>
                                        <tr className="bg-gray-100">
                                            <th className={`${theme.border} px-2 py-1 text-left`}>Sr.</th>
                                            <th className={`${theme.border} px-2 py-1 text-left`}>Material</th>
                                            <th className={`${theme.border} px-2 py-1 text-left`}>Quantity</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            <td className={`${theme.border} px-2 py-1`}>1</td>
                                            <td className={`${theme.border} px-2 py-1`}>Horizontal Bar</td>
                                            <td className={`${theme.border} px-2 py-1 font-bold ${theme.text}`}>{results?.totalHorizontalBars} Nos</td>
                                        </tr>
                                        <tr>
                                            <td className={`${theme.border} px-2 py-1`}>2</td>
                                            <td className={`${theme.border} px-2 py-1`}>Vertical Post</td>
                                            <td className={`${theme.border} px-2 py-1 font-bold text-green-600`}>{results?.verticalPosts} Nos</td>
                                        </tr>
                                    </tbody>
                                </table>
                                ...
                                <table className="w-full text-xs border-collapse">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td className={`${theme.border} px-2 py-1`}>1</td>
                                            <td className={`${theme.border} px-2 py-1`}>Horizontal Bar</td>
                                            <td className={`${theme.border} px-2 py-1 font-bold ${theme.text}`}>{results?.horizontalBarActual} Nos</td>
                                        </tr>
                                        <tr>
                                            <td className={`${theme.border} px-2 py-1`}>2</td>
                                            <td className={`${theme.border} px-2 py-1`}>Vertical Post</td>
