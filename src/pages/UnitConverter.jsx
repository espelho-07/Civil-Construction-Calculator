                    ...
                    <section className="mb-8">
                        ...
                        <div className={`bg-white rounded-xl p-6 border ${theme.border} flex flex-col md:flex-row gap-6`}>
                            <div className="flex-1">
                                <p className="text-gray-600 mb-4 text-justify">Unit conversion is a multi-step process that involves multiplication or division by a numerical factor, selection of the correct number of significant digits, and rounding.</p>
                                <p className="text-gray-600 mb-4 text-justify"><strong>Length Conversion</strong> describe between the various different sizes by merely moving the decimal point the correct number of places. The basic metric units are meters (for length).</p>
                                <p className="text-gray-600 mb-4 text-justify"><strong>Area Conversion</strong> describes the total amount of space a 2 dimensional shape covers. The units used to describe an area are based on the length of a side of a square, the standard SI unit for area is the square meter.</p>
                                <p className="text-gray-600 text-justify"><strong>Volume conversion</strong> a space any substance occupies or contains in a three dimensional space. While the SI unit for volume is the cubic meter, it is too big for common use and has been replaced with the liter (1 cubic decimeter) in everyday life.</p>
                            </div>
