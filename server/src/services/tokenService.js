...
export async function verifyRefreshToken(token) {
    ...
    // Token rotation: Delete old token (new token will be generated by controller)
    await prisma.refreshToken.delete({ where: { id: refreshToken.id } });
...
// Verify and consume Password Reset Token (atomic operation)
export async function verifyAndConsumePasswordResetToken(token) {
    ...
    return await prisma.$transaction(async (tx) => {
        ...
        // Immediately mark as used (atomic)
...
// Verify Password Reset Token (for validation only, doesn't consume)
...
// Mark Password Reset Token as Used (deprecated - use verifyAndConsumePasswordResetToken instead)
